...
.code
	...
	;после перемножения 16-битных чисел
		...
		push x
		push y
		call near ptr FuncInt ;вызов дальней процедуры для вычисления 2X^2+Y^2
		push z
		call near ptr ShiftNumber ;вызов процедуры сдвига влево EAX на значение хранящееся в 5 мл.битах числа Z
